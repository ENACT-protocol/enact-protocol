          ...
          <div className="lg:col-span-5 px-4 sm:px-6 md:px-12 py-16 sm:py-20 lg:py-24 bg-[#030305]">
            ...
            <div className="mono-label text-[var(--color-accent)] mb-6 sm:mb-8 flex items-center gap-2">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                <path d="M12 2.5L3 10h18L12 2.5z" fill="#0098EA"/>
                <path d="M3 10l9 11.5L21 10H3z" fill="#0098EA" opacity="0.65"/>
              </svg>
              TON Mainnet
            </div>
            <div className="space-y-6">
              {[['JobFactory','EQA3t751GuMhAZGnvBm0HOzxrppnz9tLuI__4XXQ_FC7BYcL'],['JettonJobFactory','EQAJpr7tz9rnawoKu-7_kAlR5YxGDFPLCT_Wh7I1IN-D6jfa']].map(([n,a])=>(
                <div key={n}>
                  ...
                  <div className="flex items-center gap-2 bg-[#0A0A0E] border border-[#1A1A24] p-3 hover:border-gray-600 transition-colors overflow-hidden">
                    ...
                    <a href={`https://tonviewer.com/${a}`} target="_blank" rel="noopener noreferrer" className="flex-shrink-0 text-gray-500 hover:text-white transition-colors" title="Tonviewer">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
                    </a>
                    <a href={`https://tonscan.org/address/${a}`} target="_blank" rel="noopener noreferrer" className="flex-shrink-0 text-gray-500 hover:text-white transition-colors" title="Tonscan">

                  ...
                  {group.items.map(item => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {badge && (
                          <span className="shrink-0 px-1.5 py-[2px] text-[10px] font-sans font-medium tracking-wide leading-none rounded-md bg-gradient-to-b from-[rgba(0,152,234,0.20)] to-[rgba(0,152,234,0.08)] text-[#7AC4F0] border border-[rgba(0,152,234,0.30)]">
                            {badge}
                          </span>
                        )}
                      </Link>

        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="relative hidden lg:block">
            <input type="text" value={headerSearch}
              ...
              className="w-[200px] xl:w-[240px] bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)] rounded-lg px-3.5 py-[7px] text-[12px] text-white placeholder-[#52525B] font-mono focus:outline-none focus:border-[#0098EA] transition-colors" />
